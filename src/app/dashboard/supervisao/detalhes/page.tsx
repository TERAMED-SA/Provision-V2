...
export default function OccurrenceDetailsPage() {
    ...
    return (
      <div className="container mx-auto py-10 px-4">
        <div className="flex items-center gap-2 mb-6">
          ...
          <BreadcrumbRoutas title="Detalhes da Supervisão" productName="Supervisão" showBackButton />
  ...
  return (
    <div className="container mx-auto py-10 px-4">
      ...
      <BreadcrumbRoutas title="Detalhes de Ocorrência" productName="Ocorrências" showBackButton />
    
        </div>

        <PDFDownloadLink
          document={<OccurrencePDF notification={notification} getPriorityLabel={getPriorityLabel} />}
          fileName={`Supervisão-${notification.siteName}-${notification._id}.pdf`}
